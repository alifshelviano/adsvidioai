  ...
  const renderVideoAd = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/30 bg-muted/20 p-12 text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold">Generate Video Ad (Hugging Face)</h3>
            <p className="mb-4 text-muted-foreground">Create a short video from a script using a Hugging Face model. Requires generated ad content first.</p>
